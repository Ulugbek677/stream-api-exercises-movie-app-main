...
public class StreamMovieAppExercise {
    ...
    public  void exercise2() {
        Map<String, Integer> movies = directorRepo.findAll()
                .stream()
                .collect(Collectors.toMap(director -> director.getName(), director -> director.getMovies().size()));
    ...
    public void exercise8() {
        Optional<Movie> a = movieRepo.findAll()
                .stream()
                .sorted((c1, c2)->Integer.compare(c1.getYear(), c2.getYear()))
                .findFirst();
    ...
    public void exercise9() {
        Double s = movieRepo.findAll()
                .stream()
                .filter(movie -> movie.getYear()==2004)
                .mapToDouble(movie->movie.getSpending())
                .sum();
    ...
    public void exercise10() {
        Double s = movieRepo.findAll()
                ...
                .average().getAsDouble();
        System.out.println("Ortace reyting : " + s);
    }
    ...
    public void exercise11() {
        ...
        Optional<Movie> a = movies.stream()
                .sorted((c1, c2)->Integer.compare(c1.getYear(), c2.getYear()))
                .findFirst();
...
//                    .stream()
//                    .filter(director -> director.getOscarCount()>0)
//                    .sorted((c1, c2)->Comparator.comparing( ))
